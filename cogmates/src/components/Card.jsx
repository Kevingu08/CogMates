...
export function Card({ card, handleCard }) {
    ...
    return (
        ...
        >
            <div className={`relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d]  ${card.flipped? '[transform:rotateY(180deg)]' : ''} border border-sky-700`}>
                <div className="absolute inset-0 [backface-visibility:hidden] bg-slate-400 rounded-xl overflow-hidden">
                    <img className="contain aspect-square" src="./src/imgs/card_img.jpeg" alt="" />
                </div>
